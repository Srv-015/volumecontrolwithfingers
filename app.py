        ...
        if results.multi_hand_landmarks:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks, results.multi_handedness):
                ...
                if gesture_detected == "Pinch":
                    ...
                    cv2.putText(frame, f"{smooth_target_vol}%", (mid_x, mid_y - 20), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (50, 50, 255), 2)
                      ...
                      cv2.putText(frame, "MUTED", (cx-30, cy-40), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                      
                      
                      
                      project_state["current_volume"] = 0
                      
                      if time.time() - last_volume_update_time > 1.0: 
